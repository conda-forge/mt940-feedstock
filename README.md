...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mt940-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14016&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mt940-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mt940` can be installed with:

```
conda install mt940
```

It is possible to list all of the versions of `mt940` available on your platform with:
